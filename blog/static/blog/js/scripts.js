...
$("img.thumb").lazyload({placeholder: "/static/images/python.jpg", effect: "fadeIn"});
$(".single .content img").lazyload({placeholder: "/static/images/python.jpg", effect: "fadeIn"});
...
jQuery.ias({
    ...
    next: '.next-page a',
    trigger: '查看更多',
    loader: '<div class="pagination-loading"><img src="/media/blog/static/blog/images/loading.gif" /></div>',
    triggerPageThreshold: 5,
    onRenderComplete: function () {
        $('.excerpt .thumb').lazyload({placeholder: '/templates/blog/images/occupying.png', threshold: 400});
        $('.excerpt img').attr('draggable', 'false');        $('.excerpt a').attr('draggable', 'false')
    }
});
$(window).scroll(function () {
    var sidebar = $('.sidebar');
